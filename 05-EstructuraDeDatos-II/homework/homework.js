...
ejercicio adicional, pueden modificar un poco la clase para que reciba la cantidad de buckets por parámetro al momento de ser 
instanciada.)
...
HashTable.prototype.get = function(key){
  let i = this.hash(key);
  if (this.buckets[i][key])return this.buckets[i][key]
}
